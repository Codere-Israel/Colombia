...
const MLB = (props) => {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "El que más ha ganado el juego de Estrellas es Liga America con un total de 46 vs. Liga Nacional con un registro de 43.",
        },
      },
      {
        "@type": "Question",
  ...
  return (
    <>
      ...
      <Floating text="Anotate un homerun" juega={false} />
      <div
      ...
      ></div>
      <Container>
        <h1 className="PageH1TitleSeoPages923 mt-2 mb-4">
        ...
        <p className="text982T">
          ...
          que se juega de manera anual entre los mejores jugadores de la Liga
          Nacional y la Liga Americana. El Juego de las Estrellas generalmente
          tiene lugar a mediados de julio y marca la mitad de la campaña de las
          Grandes Ligas.
        </p>
        <LazyLoadImage
        ...
        <p className="text982T">
          El juego de Estrellas de la Temporada 2022 de MLB está cada vez más
          cerca, tras dos años de espera, el Dodger Stadium encenderá sus luces
          para recibir a los jugadores más destacados de la primera parte de la
          campaña. Es un estadio de béisbol ubicado en la ciudad Elysian Park en
          Los Ángeles en el Estado de California. Ve preparando tus quinielas
          para que puedas realizar tus
          <a
        ...
        <p className="text982T">
          ...
          56.000 espectadores. También es el tercer estadio más longevo de las
          Grandes Ligas, solo superado por el Fenway Park en Boston construido
          en 1911 y el Wrigley Field de Chicago construido en 1914.
        </p>

        <p className="text982T">
          En 1958 el equipo de Los Angeles Dodgers robó 352 hectáreas en la zona
          de la barranca de Chávez, iniciando así la construcción del estadio.
          Mientras tanto, el equipo tuvo que jugar en el Memorial Coliseum. Fue
          el segundo estadio en ser construido solo con inversión privada
          después del Estadio Yankee y el último hasta la construcción del AT&T
          Park.
        </p>

        <p className="text982T">
          Los Dodgers de los Ángeles y los organizadores del juego de Estrellas
          2022 revelaron los precios y abrieron la venta de boletería, de
          acuerdo con un artículo de Los Angeles Times, cuatro de los boletos de
          mayor precio con impuestos incluidos tendrían un costo de $54,974.95
          dólares.
        </p>
        ...
        <p className="text982T">
          ...
          mismos fanáticos, ellos eligen a los jugadores que quieren o a los más
          populares para que vayan a disputar el juego de Estrellas 2022, las
          votaciones serán el 30 de junio, y por cada equipo van 30 jugadores
          los cuales representarán cada una de las dos conferencias.
        </p>
        ...
        <Accordion className="content-accordion" alwaysOpen>
          <Accordion.Item className="accordionT454" eventKey="0">
            ...
            <Accordion.Body className="accordionBody text982T">
              ...
              <p className="text982T">
                El que más ha ganado el juego de Estrellas es Liga America con
                un total de 46 vs. Liga Nacional con un registro de 43.
              </p>
              <h3 className="PageH3TitleSeoPages923 mt-4 mb-2">
                ¿Cómo se gana un run line?
              </h3>
              <p className="text982T">
                Un run line o handicap es cuando el equipo favorito ofrece una
                ventaja y el equipo menos favorito recibe una ventaja, para
                ganar un run line el equipo que ofrece la ventaja debe ganar o
                más carreras de las que ofrece, es decir si tiene un run line o
                handicap de - 1,5 el equipo debe ganar por 2 carreras o más, si
                recibe un run line de 1,5 el equipo debe ganar o en su defecto
                perder por menos de carreras para ganar la apuesta.
              </p>
              ...
              <p className="text982T">
                ...
                comienzo del partido se encuentra 2 x 0 a favor de que obtiene o
                realiza esta apuesta. Por lo tanto, para no ganar la apuesta
                debe perder este equipo por 2 carreras o más.
              </p>
              <h3 className="PageH3TitleSeoPages923 mt-4 mb-2">
                ¿Qué es un handicap en béisbol?
              </h3>
              <p className="text982T">
                Un handicap en béisbol es una ventaja o desventaja que otorgan
                los equipos, el favorito otorgará una ventaja, el no favorito
                recibirá una desventaja.
              </p>
            </Accordion.Body>
          </Accordion.Item>
        </Accordion>
