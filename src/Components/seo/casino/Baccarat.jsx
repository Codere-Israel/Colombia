...
export default function Baccarat(props) {
  ...
  const reglas = {
    ...
    spanbold:
      "La visión de este juego está centrada en el crupier y la mesa, por lo que tendrás una visión brillante de ambos además de interactuar en vivo con ellos. ",
    p: {
      p1: [
    ...
    <div className="cas-seo">
      ...
      <Container style={{ color: "#fff" }}>
        ...
        <div id={floor2.id}>
          ...
          <h3 className="mt-4 mb-3" id={floor2.innerTitle4_id}>
            {floor2.innerTitle4}
          </h3>
          <p>{floor2.p4}</p>
          <ol>
