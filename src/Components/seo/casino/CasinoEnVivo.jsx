  ...
  return (
    <div className="cas-seo">
      ...
      <Container style={{ color: "#fff" }}>
        ...
        {floor2 &&
          floor2.data &&
          floor2.data.map((item, index) => (
            <div key={index}>
              <h3>{item.b1.title}</h3>
              {item.b1.text.map((text, index) => (
                <p key={index}>{text}</p>
              ))}

              <h3>{item.b2.title}</h3>
              {item.b2.text.map((text, index) => (
                <p key={index}>{text}</p>
              ))}

              <h3>{item.b3.title}</h3>
              {item.b3.text.map((text, index) => (
                <p key={index}>{text}</p>
              ))}

              <h3>{item.b4.title}</h3>
              {item.b4.text.map((text, index) => (
                <p key={index}>{text}</p>
              ))}

              <h3>{item.b5.title}</h3>
              {item.b5.text.map((text, index) => (
                <p key={index}>{text}</p>
              ))}
