...
export default function Slots(props)
{
	...
	const floor1 = {
		...
		title: "Slot Online Vs. las Máquinas Tragamonedas: Diferencias y Similitudes",
		data : {
			p1: [
