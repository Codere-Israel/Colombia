...
const Splash = (props) => {
  ...
  const organization = {
    ...
    "@type": "Organization",
    "name": "codere",
    "alternateName":["codere colombia","codere.co","codere.com.co","codere co"],
    ...
    "description": "Codere es la casa de apuestas deportivas y casino online #1 en Colombia. Blackjack, ruleta online, slots y muchos tipos de deporte.",
    "sameAs": ["https://www.facebook.com/CodereColombia", "https://twitter.com/CodereCO", "https://www.youtube.com/channel/UCT46v9eapBGC-3-vSHBlRvg", "https://www.instagram.com/codereco/", "https://apps.apple.com/co/app/codere-apuestas-deportivas-co/id1313823849", "https://play.google.com/store/apps/details?id=co.codere.apuestas", "https://es.wikipedia.org/wiki/Codere", "https://www.wikidata.org/wiki/Q2918415", "https://www.crunchbase.com/organization/codere", "https://play.google.com/store/apps/details?id=co.codere.casino","https://www.google.com/search?kgmid=/g/121c515_"]
  }
  ...
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify(inicioFAQPage)}</script>
